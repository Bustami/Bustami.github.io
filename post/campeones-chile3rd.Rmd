---
title: "Ranking de Campeones Primera División Fútbol Profesional Chile [actualizado Dic 2018]"
description: ''
author: "Ismael Gómez"
lang: es
date: '2018-12-05'
...
data[which(data$Club=="Universidad Católica"), 'N_Campeonatos'] <- 13 # 2018

data[which(data$Club=="Green Cross"), 'N_Torneos'] <- 60 + 3 # hasta 2018
...
data$N_Torneos[c(1:6, 8:9, 11, 14)] <- data$N_Torneos[c(1:6, 8:9, 11, 14)] + 1 # + 2018
...
Felicitamos al Club Deportivo Universidad Católica y a todos #LosCruzados por ser los campeones de la versión N° 102 del torneo de primera división del fútbol profesional chileno, alcanzando su estrella número 13!

A continuación presentamos la actualización [**de nuestro ranking publicado previamente**](http://datofutbol.cl/campeones-chile-2nd/):
...
Colo-Colo tiene un claro liderato con sus 32 estrellas, con lo que casi le alcanza para duplicar y triplicar a sus más cercanos perseguidores (Universidad de Chile con 18 y Universidad Católica con 13), respectivamente. Cabe destacar que los 3 llamados "equipos grandes" de Chile juntos se han llevado el 62% de las copas jugadas.

Se observa que la mayoría de los campeones son equipos de la Región Metropolitana (Colo-Colo, Universidad de Chile, Universidad Católica, Unión Española, Audax Italiano, Magallanes, Palestino, Santiago Morning y Green Cross), correspondiente al 56% de los 16 equipos que han campeonado al menos una vez, y al 80% de los 102 campeonatos jugados. 
...
```
  ...
  Además de la razón campeonatos ganados/jugados que se muestra arriba de cada barra, abajo y entre paréntesis se presenta el número de torneos jugados por cada equipo en Primera División, lo que aporta a la interpretación, puesto que quienes avanzan en este ranking en comparación con al anterior lo hacen debido a que han aprovechado mejor sus participaciones en Primera División para campeonar. Cabe destacar que Colo-Colo es el único que ha jugado los 102 torneos dada su antigüedad en el fútbol criollo y porque no ha descendido nunca a Primera B o Segunda División.
